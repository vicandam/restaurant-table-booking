...
<table width="100%" cellspacing="0" cellpadding="0" border="0" name="bmeMainBody"
       style="background-color: rgb(0, 0, 0);" bgcolor="#000000">
    <tbody>
    <tr>
                                    ...
                                    <table name="bmeMainContent"
                                        ...
                                        <tr>
                                            <td width="100%" class="blk_container bmeHolder"
                                                ...
                                                style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: rgb(0, 0, 0);"
                                                bgcolor="#000000">
                                                                            ...
                                                                            <table
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top"
                                                                                        align="left"
                                                                                        name="tblCell"
                                                                                        style="padding: 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;"
                                                                                        class="tblCell">
                                                                                        <div
                                                                                            style="line-height: 150%; text-align: center;">
																															<span
                                                                                                                                style="font-size: 12px; font-family: Helvetica, Arial, sans-serif; color: #939393; line-height: 150%;">Restaurant Table
																															</span>
                                                                                            <span
                                                                                                style="font-size: 12px; font-family: Helvetica, Arial, sans-serif; color: #d63c3c; line-height: 150%;"><strong>Notification</strong></span>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                </tbody>
                                                            ...
                                                            <td>
                                                                <table width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            class="bmeImage"
                                                                            style="border-collapse: collapse; padding: 20px;">
                                                        ...
                                                        <tr>
                                                            <td class="tblCellMain"
                                                                ...
                                                                <table class="tblLine"
                                                                       ...
                                                                       cellpadding="0" border="0"
                                                                       width="100%"
                                                                       style="border-top-width: 1px; border-top-color: rgb(223, 223, 223); border-top-style: solid; min-width: 1px;">
                                                                    <tbody>
                                                                    <tr>
                                                                        <td><span></span>
                                                                        </td>
                                                                                ...
                                                                                <tr>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="padding: 20px 0px 20px 20px; font-family: Arial, Helvetica, sans-serif; font-weight: normal; font-size: 14px; color: rgb(56, 56, 56); text-align: left;"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <br>
                                                                                                        <br>
                                                                                                        <span style="font-size: 14px; font-family: Helvetica, Arial, sans-serif; color: #929292; line-height: 150%;">Someone has book a table. Please login to update booking request status. Click button below to continue.</span>
                                                                                                    </div>
                                                                                                </td>
                                                                                            </tr>
                                                                                            </tbody>
                                                                                    ...
                                                                                    <td valign="top"
                                                                                        ...
                                                                                        <table
                                                                                            ...
                                                                                            border="0"
                                                                                            class="bmeImageTable"
                                                                                            style="float: right; height: 222px;"
                                                                                            align="right"
                                                                                            dimension="30%"
                                                                                            width="187"
                                                                                            height="222">
                                                                                    ...
                                                                                    <td style="border-radius: 20px; border: 0px none transparent; text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 10px 40px; font-weight: bold; background-color: rgb(214, 60, 60);"
                                                                                        class="bmeButtonText">
																														<span
																															...
																															<a style="color:#FFFFFF; cursor: pointer;" target="_blank">Update Now</a></span>
                                                                                    </td>
                                                                                </tr>
                                                                                </tbody>
                                                                            </table>
                                ...
                                <td width="100%" class="blk_container bmeHolder" name="bmeFooter"
                                    ...
                                    <div id="dv_5" class="blk_wrapper">
                                        <table width="600" cellspacing="0" cellpadding="0" border="0"
                                               class="blk" name="blk_permission" style="">
                                            <tbody>
                                            <tr>
                                                <td name="tblCell" class="tblCell"
                                                    style="padding:20px;" valign="top" align="left">
                                                    <table cellpadding="0" cellspacing="0"
                                                           border="0" width="100%">
                                                        <tbody>
                                                        <tr>
                                                            <td name="bmePermissionText"
                                                                style="text-align:left;"
                                                                align="left"><span
                                                                    style="font-family: Arial, Helvetica, sans-serif; font-weight: normal; font-size: 11px;line-height: 140%;">
																							<a style="color: #16a7e0;"
                                                                                               target="_new"
                                                                                               href="http://benchmarkemail.benchurl.com/c/v?e=8E4B52&c=91CEA&t=1&l=7889F345&email=hL2iimIGZvj2QooSzVze1t7P%2FZjRPRKrj2c0%2B7DqUhU%3D">View
																								this email in your
																								browser</a>
																						</span></td>
                                                        </tr>
                                    ...
                                    <div id="dv_6" class="blk_wrapper">
                                        <table width="600" cellspacing="0" cellpadding="0" border="0"
                                               class="blk" name="blk_footer" style="">
                                            <tbody>
                                            <tr>
                                                <td name="tblCell" class="tblCell"
                                                    style="padding:20px;" valign="top" align="left">
                                                    <table cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td name="bmeBadgeText"
                                                                ...
                                                                align="left"><span
                                                                    id="spnFooterText"
                                                                    style="font-family: Arial, Helvetica, sans-serif; font-weight: normal; font-size: 11px; line-height: 140%;">This
																							message was sent to
																							amilcar.cruz@benchmarkemail.com
																							by
																							benchmarkdesignsystem.gmail.com@email.benchmarkapps.com
																							<br>10621 Calle Lee,
																							Building 141, Los Alamitos,
																							CA, 90720</span>
                                                                <br>
                                                                <br><span
                                                                        ...
                                                                        href=http://benchmarkemail.benchurl.com/c/su?e=8E4B52&c=91CEA&t=1&l=7889F345&email=hL2iimIGZvj2QooSzVze1t7P%2FZjRPRKrj2c0%2B7DqUhU%3D&relid=><img
                                                                            ...
                                                                            border="0"></span>
																							...
																							<a class=bmefootertext
                                                                                               ...
                                                                                               style="color:inherit;text-decoration:underline;">Manage
																								Subscription</a> |
																							<a class=bmefootertext
                                                                                               target=_new
                                                                                               ...
                                                                                               style="color:inherit;text-decoration:underline;">Forward
																								Email</a> |
																							<a class=bmefootertext
                                                                                               target=_new
                                                                                               ...
                                                                                               style="color:inherit;text-decoration:underline;">Report
																								Abuse</a>
																							<br></span></td>
                                                        </tr>
                                                        <tr>
    ...
    alt='' border=0 style="display:none;" height=1 width=1>
