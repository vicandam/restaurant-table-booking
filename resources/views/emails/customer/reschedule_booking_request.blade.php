                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="padding: 20px 0px 20px 20px; font-family: Arial, Helvetica, sans-serif; font-weight: normal; font-size: 14px; color: rgb(56, 56, 56); text-align: left;"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <br>
                                                                                                        <br>
                                                                                                        <span style="font-size: 14px; font-family: Helvetica, Arial, sans-serif; color: #929292; line-height: 150%;">Your table reservation has been rescheduled. Login to accept/decline reschedules.</span>
                                                                                                    </div>
                                                                                                </td>
                                                                                            </tr>
                                                                                            </tbody>
